...
class MainAdapter(private val list: List<Product>,private val user: User) : RecyclerView.Adapter<MainAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MainAdapter.ViewHolder, position: Int) {
        ...
        holder.itemBinding.cardView.setOnClickListener {
            ...
            val bundle = MainFragmentDirections.mainToDetail(product).arguments
            bundle.putSerializable("myProduct",product)

            it.findNavController().navigate(R.id.mainToDetail,bundle)
        }
